Feature: User can edit profile
  ...
  Scenario Outline: I update my personal information
    ...
    Scenarios: with valid information
      | name     | email              | location                                             | phone            | result                                 |
    ...
    Scenarios: with invalid information
      ...
      | John Doe | John.Doe@gmail.com |                                              | 1231231234  | Location location is invalid                 |
      | John Doe | John.Doe@gmail.com | Amphitheatre Parkway, Mountain View, CA      | 1231231234  | Location location is invalid                 |
      | John Doe | John.Doe@gmail.com | 123 Address                                  | 1231231234  | Location location is invalid                 |
      | John Doe | John.Doe@gmail.com | String                                       | 1231231234  | Location location is invalid                 |
      | John Doe | John.Doe@gmail.com | 1600 Amphitheatre Parkway, Mountain View, CA |             | Phone can't be blank                         |
      | John Doe | John.Doe@gmail.com | 1600 Amphitheatre Parkway, Mountain View, CA | 12345678900 | Phone is not a valid numeric US phone number |
      | John Doe | John.Doe@gmail.com | 1600 Amphitheatre Parkway, Mountain View, CA | aaaaaaaaaa  | Phone is not a valid numeric US phone number |
